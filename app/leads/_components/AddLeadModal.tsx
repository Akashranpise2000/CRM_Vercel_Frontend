  ...
  const handleCompanySelect = (companyId: string) => {
    ...
    if (selectedCompany) {
      setForm(prev => ({
        ...
        company_sector: selectedCompany.sector || "",
        poc_name: selectedCompany.poc?.name || "",
        poc_email: "",
        poc_phone: "",
        poc_importance: selectedCompany.poc?.importance || "Medium",
      }));
    }
  };
              ...
              <Tabs value={companyMode} onValueChange={(v) => setCompanyMode(v as 'select' | 'create')}>
                ...
                <TabsContent value="select" className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Select value={form.selectedCompanyId} onValueChange={handleCompanySelect}>
                      <SelectTrigger>
